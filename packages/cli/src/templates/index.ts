export const templates = {
  ...
  controller: (name: string, resourceful: boolean) => `import type { HttpContext } from '@pearl-framework/http'
...
`,
  ...
  model: (name: string, tableName: string) => `import { pgTable, serial, varchar, timestamp } from '@pearl-framework/database'
...
`,
  ...
  middleware: (name: string) => `import type { HttpContext, NextFn } from '@pearl-framework/http'
...
`,
  ...
  mail: (name: string) => `import { Mailable } from '@pearl-framework/mail'
...
`,
  ...
  event: (name: string) => `import { Event } from '@pearl-framework/events'
...
`,
  ...
  listener: (name: string, eventName: string) => `import { Listener } from '@pearl-framework/events'
...
`,
  ...
  request: (name: string) => `import { FormRequest } from '@pearl-framework/validate'
import { z } from 'zod'
