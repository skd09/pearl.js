...
const packageJson = (name: string) => JSON.stringify({
  ...
  dependencies: {
    '@pearl/core':     '^0.1.0',
    '@pearl/http':     '^0.1.0',
    '@pearl/validate': '^0.1.0',
    '@pearl/auth':     '^0.1.0',
    '@pearl/database': '^0.1.0',
    '@pearl/events':   '^0.1.0',
    '@pearl/queue':    '^0.1.0',
    '@pearl/mail':     '^0.1.0',
    'drizzle-orm':     '^0.30.0',
...
const serverTs = `import { Application } from '@pearl/core'
...
const appProviderTs = `import { ServiceProvider } from '@pearl/core'
...
import { HttpTestClient } from '@pearl/testing'
